...
#define PIN_WS2812B 23     // Пин, к которому подключена лента
#define NUM_PIXELS 50      // Кол-во светодиодов в ленте
#define LED_BRIGHTNESS 30                               // Базовая «глобальная» яркость (0-255), если нужно
...
#define LEFT_ENCODER_A 12    // Цифровой вход, канал A энкодера левого колеса
#define LEFT_ENCODER_B  14   // Цифровой вход, канал B энкодера левого колеса 
#define RIGHT_ENCODER_A 26   // Цифровой вход, канал A энкодера правого колеса
...
const float WHEEL_DIAMETER = 70.0;       // мм
const float WHEEL_BASE = 180.0;          // мм (расстояние между центрами колёс)
const float ENCODER_RESOLUTION = 820.0;  // тиков на оборот
